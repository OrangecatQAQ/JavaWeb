...
<a href="http://localhost:8080/ssm/create">登録</a>
<a href="http://localhost:8080/ssm/order">order</a>
<table align='center' border='1' cellspacing='0'>
    ...
    <c:forEach items="${cs}" var="c" varStatus="st">
        <tr>
			...
			<td><a href="http://localhost:8080/ssm/updatesearchCategory?customer_no=${c.customer_no}">修正</a></td>
        </tr>
    </c:forEach>
</table>
